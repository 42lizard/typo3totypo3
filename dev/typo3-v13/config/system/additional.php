...
// Project-owned DDEV configuration, shared by Development and Testing.
...
if (getenv('IS_DDEV_PROJECT') == 'true') {
    ...
    $ddevDriver = $GLOBALS['TYPO3_CONF_VARS']['DB']['Connections']['Default']['driver'] ?? 'mysqli';
    ...
    unset($ddevConfig, $ddevDriver);
}

if (\TYPO3\CMS\Core\Core\Environment::getContext()->isTesting()) {
    require __DIR__ . '/additionalTesting.php';
}
